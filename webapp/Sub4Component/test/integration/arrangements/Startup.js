sap.ui.define([
	"sap/ui/test/Opa5",
	"ui/demo/multiComponent/app/sub4component/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("ui.demo.multiComponent.app.sub4component.test.integration.arrangements.Startup", {
		...
		iRestartTheAppWithTheRememberedItem : function (oOptions) {
			...
			this.waitFor({
				success : function() {
					oOptions.hash = "EMPLOYEESet/" + sObjectId;
