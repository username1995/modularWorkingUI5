sap.ui.define([
	...
	return Opa5.extend("ui.demo.multiComponent.app.sub4component.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["ui/demo/multiComponent/app/sub4component/localService/mockserver"], function (mockserver) {
