sap.ui.define([
	...
	return BaseController.extend("ui.demo.multiComponent.app.sub5component.controller.Master", {
		...
		onOpenViewSettings : function (oEvent) {
			...
			if (!this.byId("viewSettingsDialog")) {
				Fragment.load({
					...
					name: "ui.demo.multiComponent.app.sub5component.view.ViewSettingsDialog",
					controller: this
